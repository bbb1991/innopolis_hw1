 ...
 *
 * Реализация интерфейса MBean. Позволяет с помощью jconsole узнавать сколько всего слов хранит сет
...
public class Controller implements ControllerMBean {
    ...
    /**
     * Бокс, которая хранит общий ресурс для всех потоков, где хранятся все считанные слова
     */
    private Box box;
